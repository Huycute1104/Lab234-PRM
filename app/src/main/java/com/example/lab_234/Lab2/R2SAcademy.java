...
public class R2SAcademy extends AppCompatActivity {
    TextView txtResult;
    EditText num1;
    EditText num2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r2_sacademy);
    ...
    public void div(View v) {
        ...
        if (value2 == 0) {
            Toast.makeText(R2SAcademy.this, "Cannot be divided by 0", Toast.LENGTH_SHORT).show();
        } else {
            double result = value1 / value2;
            String formattedResult = String.format("%.2f", result);
            txtResult.setText(formattedResult);
